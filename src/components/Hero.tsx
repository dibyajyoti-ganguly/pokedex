...
const Hero = () => {
  return (
    <div className="flex flex-col items-center mx-auto w-2/5 font-onest text-white gap-10">
      ...
      <button className="flex items-center gap-2 mb-6 bg-gradient-to-b from-[#1F1335] to-[#0A0611] hover:from-[#2A1D45] hover:to-[#140A22] py-2.5 px-5 rounded-xl text-lg cursor-pointer font-medium transition-colors duration-200">
        <span>&lt;/&gt;</span>
        Get Started
      </button>
